 ...
 *  @author Kevin Wayne
 */
public class DepthFirstSearch_Project {
     ...
     */
    public DepthFirstSearch_Project(SymbolDigraphWeighted G, int s) {
...
//        DepthFirstSearch_Project search = new DepthFirstSearch_Project(G, s);
//        for (int v = 0; v < G.V(); v++) {
//            if (search.marked(v))
//                StdOut.print(v + " ");
//        }
