...
public class SymbolDigraphWeighted implements Serializable {
     ...
     */
    @Deprecated
    public edu.princeton.cs.algs4.EdgeWeightedDigraph G() {
        return graph;
    }
     ...
     * @return the digraph associated with the symbol digraph
     */
    public edu.princeton.cs.algs4.EdgeWeightedDigraph digraph() {
        return graph;
    }
...
//        SymbolDigraphWeighted sg = new SymbolDigraphWeighted(filename, delimiter);
//        EdgeWeightedDigraph graph = sg.digraph();
//        while (!StdIn.isEmpty()) {
//            String t = StdIn.readLine();
//            for (Edge v : graph.adj(sg.index(t))) {
