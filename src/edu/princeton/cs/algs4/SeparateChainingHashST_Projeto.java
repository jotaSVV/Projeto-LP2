 ...
 *  @author Kevin Wayne
 */
public class SeparateChainingHashST_Projeto<Key, Value> implements Serializable {
     ...
     */
    public SeparateChainingHashST_Projeto() {
        this(INIT_CAPACITY);
    }
     ...
     */
    public SeparateChainingHashST_Projeto(int m) {
        this.m = m;
    ...
    private void resize(int chains) {
        SeparateChainingHashST_Projeto<Key, Value> temp = new SeparateChainingHashST_Projeto<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) { 
        SeparateChainingHashST_Projeto<String, Integer> st = new SeparateChainingHashST_Projeto<String, Integer>();
